...
> Plan gốc (URL fix + DB + pilot Catalog): [Frontend Fix & UI Revamp Plan](./frontend-fix-and-ui-revamp-plan.md).
...
- [Frontend Fix & UI Revamp Plan](./frontend-fix-and-ui-revamp-plan.md) — plan gốc của đợt UI
