...
> Nguồn: [IMPLEMENTATION-STATUS.md](./IMPLEMENTATION-STATUS.md), [flows.md](./flows.md)
...
- [Implementation Status](./IMPLEMENTATION-STATUS.md) — source of truth trạng thái prototype
- [System Flows](./flows.md) — 9 luồng nghiệp vụ chính
