import {
  ...
  EmptyOrderError,
} from './order-header.entity';
import { OrderLine } from './order-line.entity';

function createLine(overrides: Partial<{ id: string; quantity: number; unitPrice: number }> = {}): OrderLine {
...
describe('OrderHeader', () => {
  describe('createDraft', () => {
    it('should create a draft order with empty lines and zero total', () => {
      const order = OrderHeader.createDraft('order-1', 'customer-1');
