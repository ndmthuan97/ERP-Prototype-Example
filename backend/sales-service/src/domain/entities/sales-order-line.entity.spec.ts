...
describe('SalesOrderLine', () => {
  describe('create', () => {
    it('should calculate lineTotal = quantity × unitPrice', () => {
      const line = SalesOrderLine.create('l1', 'item-1', 'Bàn gỗ', 10, 1500000);
    ...
    it('should reject non-integer quantity', () => {
      expect(() => SalesOrderLine.create('l1', 'item-1', 'Test', 1.5, 100)).toThrow(
        'Số lượng phải là số nguyên dương',
      );
    });

    it('should reject unitPrice <= 0', () => {
      expect(() => SalesOrderLine.create('l1', 'item-1', 'Test', 1, 0)).toThrow(
