// =============================================================================
// PRISMA OUTBOX STORE — Adapter cho OutboxStore (port @erp/shared) — Sales
// =============================================================================
// Giống customer/inventory: CLAIM bằng FOR UPDATE SKIP LOCKED (an toàn đa-instance)
// + retry/DLQ. Schema "sales" (khớp schema.prisma @@schema("sales")).
