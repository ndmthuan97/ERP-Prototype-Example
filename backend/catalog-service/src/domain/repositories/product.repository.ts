...
export interface IProductRepository {
  ...
  create(product: Product, event?: { eventType: string; payload: unknown }): Promise<Product>;
  update(product: Product, events?: { eventType: string; payload: unknown }[]): Promise<Product>;
}
